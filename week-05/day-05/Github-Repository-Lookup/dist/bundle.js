...
(function () {
  var API = 'https://api.github.com/repos/greenfox-academy/';
  var RECOMMENDED_API = 'https://api.github.com/search/repositories?q=topic:epam-jsa';
  var TOKEN = '81f5101aaaee66e6463370b0892a10fbab5d7ca1';
  var loginButton = document.querySelector('.login button');
  var logoutButton = document.querySelector('.user button');
  var loginDiv = document.querySelector('.login');
  var userDiv = document.querySelector('.user');
  var searchButton = document.querySelector('#search');
  var descriptionDiv = document.querySelector('.description');
  var commitsDiv = document.querySelector('.commits');
  var recommendedDiv = document.querySelector('.recommended');
  ...
  loginButton.addEventListener('click', function () {
    ...
    var authorization = 'Basic ' + btoa(username + ":" + token);
  ...
  function fetchRepository() {
    var searchKey = document.querySelector('#search-key').value;
    var myHeaders = new Headers();
    myHeaders.append('Authorization', localStorage.authorization);
    var myRequest = new Request(API + searchKey, { 'method': 'GET', 'headers': myHeaders });
    fetch(myRequest).then(function (response) {
      return response.json();
    }).then(generateRepository).catch(function (error) {
      errorHandller(error);
    });
  }
  ...
  function fetchCommits() {
    ...
    var myHeaders = new Headers();
    myHeaders.append('Authorization', localStorage.authorization);
    var myRequest = new Request(API + searchKey + '/commits', { 'method': 'GET', 'headers': myHeaders });
    fetch(myRequest).then(function (response) {
      return response.json();
    }).then(generateCommits).catch(function (error) {
      errorHandller(error);
    });
  }
  ...
  function getRecommendedRepo() {
    var myHeaders = new Headers();
    myHeaders.append('Authorization', localStorage.authorization);
    var myRequest = new Request(RECOMMENDED_API, { 'method': 'GET', 'headers': myHeaders });
    fetch(myRequest).then(function (response) {
      return response.json();
    }).then(generateRecommendedRepo).catch(function (error) {
...
// module
exports.push([module.i, "body {\n  font-family: 'Work Sans', sans-serif;\n  margin: 0 auto;\n  width: 70%; }\n\ninput {\n  border: 0;\n  border-bottom: 2px solid black;\n  background-color: #43b77a; }\n\n.hide {\n  display: none; }\n\n.title {\n  margin: 10px 0; }\n\n.date-info {\n  font-style: italic;\n  font-size: 14px;\n  color: #566964; }\n\nbutton:hover {\n  cursor: pointer; }\n\nheader {\n  background-color: #245580;\n  padding: 15px; }\n  header a {\n    background-color: #fefc38;\n    padding: 5px;\n    text-decoration: none; }\n\n.main-div {\n  background-color: #43b77a; }\n  .main-div .search {\n    text-align: center;\n    font-size: 40px; }\n    .main-div .search input {\n      font-size: 40px; }\n    .main-div .search button {\n      background-color: #43b77a;\n      font-size: 28px;\n      margin-left: 6px; }\n  .main-div .main-content {\n    display: flex;\n    flex-direction: row-reverse; }\n    .main-div .main-content .right-sidebar {\n      width: 35%; }\n      .main-div .main-content .right-sidebar p {\n        font-size: 30px;\n        text-decoration: underline; }\n      .main-div .main-content .right-sidebar button {\n        width: 80%;\n        height: 25px;\n        background-color: #245580;\n        margin-top: 5px;\n        font-size: 16px; }\n      .main-div .main-content .right-sidebar .login input {\n        font-size: 30px;\n        width: 80%; }\n      .main-div .main-content .right-sidebar .recommended button {\n        background-color: #43b77a;\n        border: 0;\n        text-align: right; }\n    .main-div .main-content .repository-info {\n      width: 60%; }\n      .main-div .main-content .repository-info p {\n        margin: 0; }\n      .main-div .main-content .repository-info span {\n        background-color: #fefc38;\n        font-size: 30px; }\n      .main-div .main-content .repository-info .commits {\n        margin-top: 20px; }\n        .main-div .main-content .repository-info .commits .single-commit {\n          margin: 10px 0; }\n", ""]);
